...
//: ## Strings
//: Some basic string maniuplations that are part of the Swift
//: standard library
...
greeting = "this string should be capitalized".capitalized
print(greeting)

// Another NSString method
greeting = "hello".appending(" world")
print(greeting)
...
//: ## Tuples
//: Tuples group multiple values into a single compound value. The values within a tuple can be of any type and do not have to be of the same type as each other.  Tuples observe the `let` or `var` mutability declarion.--=-=--==-0
...
let string = "Name:\(firstName.uppercased()) Sector:\(sector) Year Worked:\(years)"
print(string)
